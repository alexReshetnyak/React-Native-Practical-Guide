    ...
    return (
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <PickImage control={controls.image} onImagePicked={this.imagePickedHandler}/>
          <PickLocation control={controls.location} onLocationPick={this.locationPickedHandler}/>
          <PlaceInput 
            controls={controls}
