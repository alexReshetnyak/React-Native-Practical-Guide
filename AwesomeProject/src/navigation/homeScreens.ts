 ...
 *     getFindPlaceScreen()
 */
export const getFindPlaceScreen: () => Promise<LayoutStackChildren> =
  async () => ({
    component: {
 ...
 *     getSharePlaceScreen()
 */
export const getSharePlaceScreen: () => Promise<LayoutStackChildren> =
  async () => ({
    component: {
 ...
 */
export const getPlaceDetailScreen = async (selectedPlace: any) => ({
  component: {
